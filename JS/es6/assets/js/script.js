...
for (let cont = 0; cont <= starWarsCharacters.length; cont++) {
  charactersNames.push(starWarsCharacters[cont].name);
}
...
for (let cont = 0; cont < starWarsCharacters.length; cont++) {
  if (starWarsCharacters[cont].gender === "female") {
    femaleCharacters.push(starWarsCharacters[cont]);
  }
}
...
for (let cont = 0; cont < starWarsCharacters.length; cont++) {
  let starWarsCharacter = starWarsCharacters[cont];
...
while(cont != starWarsCharacters.length) {
  totalMass += starWarsCharacters[cont].mass;
  cont ++;
}
